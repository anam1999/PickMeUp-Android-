...
public class LihatFeedbackPKW extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_feedback_p_k_w);
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override public void run() {
                        ...
                        llayout.setBackground(ContextCompat.getDrawable(LihatFeedbackPKW.this, R.color.ecoranger));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inten = new Intent(LihatFeedbackPKW.this, BerandaPetugasKontenReward.class);
