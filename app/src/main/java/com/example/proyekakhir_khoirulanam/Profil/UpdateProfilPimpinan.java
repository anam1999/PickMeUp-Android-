...
public class UpdateProfilPimpinan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profil_pimpinan);
        ...
        kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UpdateProfilPimpinan.this, ProfilPimpinan.class);
    ...
    private void pickImage() {
        CropImage.activity()
                ...
                .setAspectRatio(4,3)
                .start(UpdateProfilPimpinan.this);
        ;
    }
    @Override
