...
public class UpdateProfilPetugasKontenReward extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_profil_petugas_konten_reward);
        ...
        kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UpdateProfilPetugasKontenReward.this, BerandaPetugasKontenReward.class);
    ...
    private void pickImage() {
        CropImage.activity()
                ...
                .setAspectRatio(4,3)
                .start(UpdateProfilPetugasKontenReward.this);
        ;
    }
    @Override
    ...
    private void UPDATE() {
        ...
        String url ="http://192.168.43.229/relasi/public/api/editdatapkw/"+getIntent().getStringExtra(TAG_ID) ;
