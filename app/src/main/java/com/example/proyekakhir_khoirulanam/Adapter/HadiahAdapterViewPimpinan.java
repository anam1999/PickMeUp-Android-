...
import com.example.proyekakhir_khoirulanam.Hadiah.DetailHadiah_Pimpinan;
import com.example.proyekakhir_khoirulanam.R;

import java.util.ArrayList;

public class HadiahAdapterViewPimpinan extends RecyclerView.Adapter<HadiahAdapterViewPimpinan.ViewHolder> {
    String id;
    ...
    @NonNull
    @Override
    public HadiahAdapterViewPimpinan.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final HadiahAdapterViewPimpinan.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(holder.itemView.getContext(), DetailHadiah_Pimpinan.class);
